...
@WebServlet(name = "EngineInfoCollector", urlPatterns = "/EngineInfoCollector")
public class EngineInfoCollector extends HttpServlet {
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        FileUtil.appendToFile(WatchDogConfig.readProperty("engineLog"), lineFormater(engineURL, engineTimestamp, msg, type));
    }
